...
RUN mkdir -p ${INSTALL_PATH} &&\
    ...
    wget https://openresty.org/package/centos/7/x86_64/openresty-openssl111-1.1.1w-1.el7.x86_64.rpm -P ${INSTALL_PATH} &&\
    wget https://openresty.org/package/centos/7/x86_64/openresty-1.19.9.1-1.el7.x86_64.rpm -P ${INSTALL_PATH}
...
RUN chmod 775 ${INSTALL_PATH}/*.rpm &&\
    ...
    rpm -ivh ${INSTALL_PATH}/openresty-openssl111-1.1.1w-1.el7.x86_64.rpm --replacefiles &&\
    rpm -ivh ${INSTALL_PATH}/openresty-1.19.9.1-1.el7.x86_64.rpm --replacefiles
