...
include_dict = {
    ...
    '__BK_CI_MQ_DEFAULT_BINDER__': '{{ include "bkci.defaultBinder" . }}',
    ...
    '__BK_CI_PULSAR_URL__': '{{ include "bkci.pulsarUrl" . }}',
    '__BK_CI_PULSAR_AUTH_TOKEN__': '{{ include "bkci.pulsarAuthToken" . }}',
    '__BK_CI_PULSAR_TENANT__': '{{ include "bkci.pulsarTenant" . }}',
    '__BK_CI_PULSAR_NAMESPACE__': '{{ include "bkci.pulsarNamespace" . }}',
    ...
    'BK_CI_PULSAR_URL': '{{ include "bkci.pulsarServiceUrl"}}',
    'BK_CI_PULSAR_AUTH_TOKEN': '{{ include "bkci.pulsarTokenAuthValue" }}',
    'BK_CI_PULSAR_TENANT': '{{ include "bkci.pulsarTenant" }}',
    "BK_CI_PULSAR_NAMESPACE": '{{ include "bkci.pulsarNamespace" }}',
