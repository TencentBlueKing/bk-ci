...
BK-CI是一个开源的CI服务，可视化的UI编排流水线可助你轻松进行自动化构建-测试-发布工作流，持续、快速、高质量地交付你的产品。
...
- **代码检查**：基于 [BK-CodeCC](https://github.com/TencentBlueKing/bk-codecc) 提供专业的代码检查解决方案，检查缺陷、安全漏洞、规范等多种维度代码问题，为产品质量保驾护航。
