...
BEGIN
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER TABLE T_PIPELINE_BUILD_COMMITS ADD COLUMN `URL` varcher(255) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '仓库url';
    END IF;
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER TABLE T_PIPELINE_BUILD_COMMITS ADD COLUMN `EVENT_TYPE` varcher(32) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '触发事件类型';
    END IF;
