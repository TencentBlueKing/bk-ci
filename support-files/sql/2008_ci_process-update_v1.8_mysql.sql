...
BEGIN
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER table T_TEMPLATE add column `URL` varcher(255) NOT NULL COMMENT "仓库url";
    END IF;
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER table T_TEMPLATE add column `EVENT_TYPE` varcher(32) NOT NULL COMMENT "触发事件类型";
    END IF;
