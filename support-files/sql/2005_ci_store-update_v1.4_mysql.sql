...
BEGIN
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER TABLE T_STORE_STATISTICS_TOTAL ADD COLUMN `PIPELINE_NUM` INT(11) DEFAULT '0';
    END IF;
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER TABLE T_STORE_STATISTICS_TOTAL ADD COLUMN `RECENT_EXECUTE_NUM` INT(11) DEFAULT '0';
    END IF;
