...
REPLACE INTO `T_PIPELINE_RULE`(`ID`, `RULE_NAME`, `BUS_CODE`, `PROCESSOR`) VALUES ('c5946af9754946d6a0ed9d1f63107bf1', 'BK_CI_PROJECT_NAME_CN', 'BUILD_NUM', 'BkVarProcessor');
REPLACE INTO `T_PIPELINE_RULE`(`ID`, `RULE_NAME`, `BUS_CODE`, `PROCESSOR`) VALUES ('ce759c669c6642d6bfee7faf03f717a5', 'BK_CI_REPO_GIT_WEBHOOK_SOURCE_BRANCH', 'BUILD_NUM', 'BkVarProcessor');
REPLACE INTO `T_PIPELINE_RULE`(`ID`, `RULE_NAME`, `BUS_CODE`, `PROCESSOR`) VALUES ('03a12d6607734b858c5e76acb5e4add2', 'BK_CI_BUILD_NUM', 'BUILD_NUM', 'BkVarProcessor');
REPLACE INTO `T_PIPELINE_RULE`(`ID`, `RULE_NAME`, `BUS_CODE`, `PROCESSOR`) VALUES ('5d6a9ab5f012418ab4827fcb98f564ad', 'BK_CI_PIPELINE_NAME', 'BUILD_NUM', 'BkVarProcessor');
