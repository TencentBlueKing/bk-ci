...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_INFO` (
  ...
  `LOCK_USER` varchar(64) DEFAULT NULL COMMENT 'UI禁用操作人',
  `LOCK_REASON` varchar(255) DEFAULT NULL COMMENT 'UI禁用原因',
  `YAML_LOCKED` bit(1) DEFAULT b'0' COMMENT 'YAML是否禁用',
  `YAML_LOCK_USER` varchar(64) DEFAULT NULL COMMENT 'YAML禁用操作人',
