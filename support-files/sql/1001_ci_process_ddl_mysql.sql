...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_HISTORY` (
  ...
  `VERSION_NUM` int(11) DEFAULT NULL COMMENT '正式发布版本号',
  PRIMARY KEY (`BUILD_ID`),
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_INFO` (
  ...
  `ONLY_DRAFT` bit(1) DEFAULT b'0' COMMENT '是否存在草稿版本',
  PRIMARY KEY (`PIPELINE_ID`),
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_RESOURCE` (
  ...
  `PIPELINE_VERSION` int(11) DEFAULT '1' COMMENT '流水线模型版本',
  `TRIGGER_VERSION` int(11) DEFAULT '1' COMMENT '触发器模型版本',
  `SETTING_VERSION` int(11) DEFAULT '1' COMMENT '关联的流水线设置版本号',
