...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_COPY_TASK` (
  `TASK_ID` varchar(64) NOT NULL COMMENT '任务ID',
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
  `TASK_NAME` varchar(128) DEFAULT NULL COMMENT '任务名称',
  `TARGET_PROJECT_ID` varchar(64) DEFAULT NULL COMMENT '目标项目ID',
  `PIPELINE_COPY_STRATEGY` varchar(64) DEFAULT NULL COMMENT '流水线ID处理策略',
  `STATUS` varchar(32) NOT NULL COMMENT '复制状态',
  `PIPELINE_COUNT` int(11) NOT NULL DEFAULT 0 COMMENT '流水线复制数量',
  `SUB_PIPELINE_COUNT` int(11) NOT NULL DEFAULT 0 COMMENT '自动添加的子流水线数量',
  `PAC_COUNT` int(11) NOT NULL DEFAULT 0 COMMENT '自动排除的PAC数量',
  `UNPROCESSED_COUNT` int(11) NOT NULL DEFAULT 0 COMMENT '未处理的资源数',
  `HIGH_RISK_COUNT` int(11) NOT NULL DEFAULT 0 COMMENT '高风险资源数',
  `AUTO_FINISH_COUNT` int(11) NOT NULL DEFAULT 0 COMMENT '自动完成的资源数量',
  `CREATE_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `UPDATE_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`PROJECT_ID`, `TASK_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='流水线复制任务表';
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_COPY_TASK_RESOURCE` (
    ...
    `COPY_ACTION`                varchar(32)  NOT NULL DEFAULT 'AUTO_FINISH' COMMENT '资源复制动作',
    `TARGET_PROJECT_ID`          varchar(64)           DEFAULT NULL COMMENT '目标项目ID',
