...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BATCH_TASK_DETAIL` (
  ...
  `DRAFT` bit(1) NOT NULL DEFAULT b'0' COMMENT '流水线是否是草稿',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_COPY_TASK` (
  ...
  `PIPELINE_COPY_STRATEGY` varchar(64) NOT NULL COMMENT '流水线ID处理策略',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_COPY_TASK_RESOURCE` (
  ...
  `RESOURCE_ID` varchar(128) NOT NULL COMMENT '源资源ID',
  ...
  KEY `IDX_TASK_PIPELINE` (`PROJECT_ID`, `TASK_ID`, `PIPELINE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='流水线复制任务资源表';
