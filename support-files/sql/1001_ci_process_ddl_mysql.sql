...
-- devops_process.T_PIPELINE_PUBLIC_VAR definition
CREATE TABLE IF NOT EXISTS `T_PIPELINE_PUBLIC_VAR` (
...
-- devops_process.T_PIPELINE_PUBLIC_VAR_GROUP definition
CREATE TABLE IF NOT EXISTS `T_PIPELINE_PUBLIC_VAR_GROUP` (
    `ID` bigint(32) NOT NULL COMMENT '主键ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `GROUP_NAME` varchar(64) NOT NULL DEFAULT '' COMMENT '变量组名称',
    `VERSION` int(11) NOT NULL DEFAULT '1' COMMENT '版本号',
...
-- devops_process.T_PIPELINE_PUBLIC_VAR_GROUP_REFER_INFO definition
CREATE TABLE IF NOT EXISTS `T_PIPELINE_PUBLIC_VAR_GROUP_REFER_INFO` (
    `ID` bigint(32) NOT NULL COMMENT '主键ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `GROUP_NAME` varchar(64) NOT NULL DEFAULT '' COMMENT '变量组名称',
...
-- devops_process.T_PIPELINE_PUBLIC_VAR_GROUP_RELEASE_RECORD definition

CREATE TABLE IF NOT EXISTS `T_PIPELINE_PUBLIC_VAR_GROUP_RELEASE_RECORD` (
    `ID` bigint(32) NOT NULL COMMENT '主键ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `GROUP_NAME` varchar(64) NOT NULL DEFAULT '' COMMENT '变量组名称',
    `VERSION` int(11) NOT NULL DEFAULT '1' COMMENT '版本号',
...
-- devops_process.T_PIPELINE_PUBLIC_VAR_REFER_INFO definition

CREATE TABLE IF NOT EXISTS `T_PIPELINE_PUBLIC_VAR_REFER_INFO` (
    `ID` bigint(32) NOT NULL COMMENT '主键ID',
    `GROUP_NAME` varchar(64) NOT NULL DEFAULT '' COMMENT '变量组名称',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `VAR_NAME` varchar(64) NOT NULL DEFAULT '' COMMENT '变量名称',
