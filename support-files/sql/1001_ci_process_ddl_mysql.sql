...
CREATE TABLE IF NOT EXISTS `T_RESOURCE_PUBLIC_VAR` (
    ...
    KEY `INX_TPPV_VAR_PROJECT_NAME` (`PROJECT_ID`,`VAR_NAME`)
...
CREATE TABLE IF NOT EXISTS `T_RESOURCE_PUBLIC_VAR_GROUP_REFER_INFO` (
    ...
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `GROUP_NAME` varchar(64) NOT NULL DEFAULT '' COMMENT '变量组名称',
    `VERSION` int(11) NOT NULL COMMENT '变量组版本号,-1代表未指定关联的变量组版本',
    ...
    PRIMARY KEY (`ID`),
    UNIQUE KEY `UNI_INX_TPPVGRI_VAR_GROUP_PROJECT_REFER_VERSION` (`PROJECT_ID`,`GROUP_NAME`,`VERSION`,`REFER_TYPE`,`REFER_ID`,`REFER_VERSION`),
    KEY `INX_TPPVRI_VAR_PROJECT_NAME_VERSION` (`PROJECT_ID`,`GROUP_NAME`,`VERSION`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `T_RESOURCE_PUBLIC_VAR_REFER_INFO` (
    ...
    `REFER_VERSION` int(11) NOT NULL DEFAULT '1' COMMENT '引用版本号',
    PRIMARY KEY (`ID`),
    UNIQUE KEY `UNI_INX_TPPVRI_VAR_PROJECT_REFER_VERSION` (`PROJECT_ID`,`GROUP_NAME`,`VERSION`,`VAR_NAME`,`REFER_TYPE`,`REFER_ID`,`REFER_VERSION`)
...
CREATE TABLE IF NOT EXISTS `T_VAR_REF_DETAIL` (
   ...
   `MODIFIER` varchar(50) NOT NULL DEFAULT 'system' COMMENT '修改者',
   `UPDATE_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '修改时间',
   `CREATE_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT
