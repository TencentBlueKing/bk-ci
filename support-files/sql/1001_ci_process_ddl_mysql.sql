...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_SENSITIVE_VALUE` (
  `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
  `PROJECT_ID` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
  `PIPELINE_ID` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
  `VALUE` varchar(4000) NOT NULL DEFAULT '' COMMENT '变量值限制4000字符',
  `CREATE_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (`BUILD_ID`,`CREATE_TIME`),
  KEY `IDX_SEARCH_BUILD_ID` (`PROJECT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='流水线构建敏感信息表';
