...
CREATE TABLE IF NOT EXISTS `T_NOTICE` (
  ...
  `EFFECT_DATE` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '??Ч????',
  `INVALID_DATE` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'ʧЧ????',
  ...
  `REDIRECT_URL` varchar(200) DEFAULT NULL COMMENT '??ת??ַ',
  PRIMARY KEY (`ID`),
...
) ENGINE=InnoDB AUTO_INCREMENT=271939 DEFAULT CHARSET=utf8;
