...
BEGIN
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER TABLE T_EXPERIENCE ADD COLUMN PIPELINE_ID varchar(34) NOT NULL COMMENT '流水线ID';
    END IF;
  ...
  END IF;
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER TABLE T_EXPERIENCE ADD COLUMN BUILD_ID varchar(34) NOT NULL COMMENT '构建ID';
    END IF;
