...
CREATE TABLE `T_PLUGIN_CODECC_ELEMENT` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `T_PLUGIN_GCLOUD_CONF` (
...
CREATE TABLE `T_PLUGIN_GIT_CHECK` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `T_PLUGIN_GITHUB_CHECK` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `PIPELINE_ID` varchar(64) NOT NULL,
  `BUILD_NUMBER` int(11) NOT NULL,
  `REPO_ID` varchar(64) DEFAULT NULL,
...
CREATE TABLE `T_PLUGIN_GITHUB_DEV_STAT` (
...
CREATE TABLE `T_PLUGIN_GITHUB_STAT` (
  `ID` varchar(32) NOT NULL DEFAULT '' COMMENT 'ID',
  `OWNER` varchar(64) NOT NULL DEFAULT '' COMMENT '代码库owner',
  `REPO` varchar(64) NOT NULL DEFAULT '' COMMENT '代码库英文名',
  `STAT_DATE` varchar(32) NOT NULL DEFAULT '' COMMENT '统计日期',
...
CREATE TABLE `T_PLUGIN_JINGANG_RESULT` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `BUILD_ID` varchar(34) DEFAULT NULL,
...
CREATE TABLE `T_PLUGIN_TASK_DATA` (
...
CREATE TABLE `T_PLUGIN_TGIT_GROUP_STAT` (
...
CREATE TABLE `T_PLUGIN_THIRDPARTY_AGENT` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `T_PLUGIN_WETEST_INST_RESULT` (
  `ID` int(11) NOT NULL,
...
CREATE TABLE `T_PLUGIN_WETEST_TASK_INST` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `T_PLUGIN_ZHIYUN_PRODUCT` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
