...
CREATE TABLE IF NOT EXISTS `T_STORE_STATISTICS_TOTAL` (
  ...
  `RECENT_EXECUTE_NUM` INT(11) DEFAULT '0',
  `CREATE_TIME` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `UPDATE_TIME` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS  `T_STORE_SENSITIVE_API` (
  ...
  `API_STATUS` VARCHAR(64) NOT NULL DEFAULT '',
  `API_LEVEL` VARCHAR(64) NOT NULL DEFAULT '',
  `APPLY_DESC` VARCHAR(1024) DEFAULT NULL,
  `APPROVE_MSG` VARCHAR(1024) DEFAULT NULL,
