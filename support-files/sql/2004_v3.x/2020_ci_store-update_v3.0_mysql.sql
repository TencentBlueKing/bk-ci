...
BEGIN
    ...
    IF NOT EXISTS(SELECT 1
                   ...
                   WHERE TABLE_SCHEMA = db
                     ...
                     AND INDEX_NAME = 'UNI_INX_TSPR_STORE_PROJECT_TYPE_INSTANCE') THEN
    ALTER TABLE `T_STORE_PROJECT_REL` ADD UNIQUE INDEX
        `UNI_INX_TSPR_STORE_PROJECT_TYPE_INSTANCE` (`STORE_TYPE`,`STORE_CODE`,`PROJECT_CODE`,`TYPE`,`INSTANCE_ID`);
    END IF;
