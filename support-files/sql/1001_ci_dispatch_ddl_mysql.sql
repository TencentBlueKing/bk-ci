...
CREATE TABLE IF NOT EXISTS `T_DISPATCH_THIRDPARTY_AGENT_DOCKER_DEBUG`  (
  ...
  `STATUS` int(11) NOT NULL COMMENT '状态',
  `IMAGE_NAME` varchar(1024) CHARACTER SET utf8mb4 NOT NULL COMMENT '镜像名称',
  `CREATED_TIME` datetime NOT NULL COMMENT '创建时间',
  `UPDATED_TIME` datetime NOT NULL COMMENT '修改时间',
  `REGISTRY_USER` varchar(128) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '注册用户名',
  `REGISTRY_PWD` varchar(128) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '注册用户密码',
