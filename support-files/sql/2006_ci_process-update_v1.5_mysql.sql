...
BEGIN
	...
	IF NOT EXISTS(SELECT 1
        ...
        ALTER TABLE T_PIPELINE_SETTING ADD COLUMN `BUILD_NUM_RULE` VARCHAR(512) COMMENT '自定义构建号规则';
    END IF;
	...
	IF NOT EXISTS(SELECT 1
                      ...
                      WHERE TABLE_SCHEMA = db
                        ...
                        AND COLUMN_NAME = 'BUILD_NUM_ALIAS') THEN
        ALTER TABLE T_PIPELINE_BUILD_SUMMARY ADD COLUMN `BUILD_NUM_ALIAS` VARCHAR(256) COMMENT '更新时间';
    END IF;
