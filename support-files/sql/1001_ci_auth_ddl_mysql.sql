...
CREATE TABLE `T_AUTH_OAUTH2_CLIENT_DETAILS` (
    ...
    `WEB_SERVER_REDIRECT_URI` VARCHAR(255) DEFAULT NULL COMMENT '跳转链接',
...
CREATE TABLE `T_AUTH_OAUTH2_CODE` (
    `CLIENT_ID` VARCHAR(32) NOT NULL COMMENT '客户端标识',
...
CREATE TABLE `T_AUTH_OAUTH2_ACCESS_TOKEN` (
...
CREATE TABLE `T_AUTH_OAUTH2_REFRESH_TOKEN` (
...
CREATE TABLE `T_AUTH_OAUTH2_SCOPE` (
    `ID` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主健ID',
...
CREATE TABLE `T_AUTH_OAUTH2_SCOPE_OPERATION_INFORMATION` (
   `ID` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主健ID',
