...
CREATE TABLE `T_AUTH_GROUP_INFO` (
  ...
  `GROUP_TYPE` VARCHAR(32) NOT NULL COMMENT '用户组类型',
...
CREATE TABLE IF NOT EXISTS `T_AUTH_IAM_CALLBACK` (
   `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
   `GATEWAY` varchar(32) NOT NULL DEFAULT '""' COMMENT '目标服务网关',
   `PATH` varchar(64) NOT NULL DEFAULT '""' COMMENT '目标接口路径',
