...
CREATE TABLE IF NOT EXISTS `T_OPENAPI_METRICS_FOR_API`(
  ...
  `APP_CODE` VARCHAR(64) NOT NULL COMMENT 'APP编码',
  `USER_ID` VARCHAR(64) NOT NULL COMMENT 'api请求用户',
  ...
  UNIQUE INDEX `IDX_APP_USER` (`API`, `APP_CODE`, `USER_ID`)
...
CREATE TABLE IF NOT EXISTS `T_OPENAPI_METRICS_FOR_PROJECT`(
  ...
  `APP_CODE` VARCHAR(64) NOT NULL COMMENT 'APP编码',
  `USER_ID` VARCHAR(64) NOT NULL COMMENT 'api请求用户',
  `CALL_LAST_DAY` int(11) NOT NULL COMMENT '昨日',
  INDEX `IDX_API` (`API`),
  INDEX `IDX_APP` (`APP_CODE`),
  INDEX `IDX_USER_ID` (`USER_ID`),
  UNIQUE INDEX `IDX_APP_USER` (`PROJECT`, `API`, `APP_CODE`, `USER_ID`)
