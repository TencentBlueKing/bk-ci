...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_CONTAINER_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_CONTAINER_1` (
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '流水线ID',
    `BUILD_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '构建ID',
    `STAGE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '当前stageId',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_DETAIL_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_DETAIL_1` (
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `BUILD_NUM` int(20) DEFAULT NULL COMMENT '构建次数',
    `MODEL` mediumtext COMMENT '流水线模型',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_HISTORY_0` (
  `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_HISTORY_1` (
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `PARENT_BUILD_ID` varchar(34) DEFAULT NULL COMMENT '父级构建ID',
    `PARENT_TASK_ID` varchar(34) DEFAULT NULL COMMENT '父级任务ID',
    `BUILD_NUM` int(20) DEFAULT '0' COMMENT '构建次数',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_STAGE_0` (
  `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
  `PIPELINE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '流水线ID',
  `BUILD_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '构建ID',
  `STAGE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '当前stageId',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_STAGE_1` (
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '流水线ID',
    `BUILD_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '构建ID',
    `STAGE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '当前stageId',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_SUMMARY_0` (
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_SUMMARY_1` (
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `BUILD_NUM` int(11) DEFAULT '0' COMMENT '构建次数',
    `BUILD_NO` int(11) DEFAULT '0' COMMENT '构建号',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_TASK_0` (
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
  `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_TASK_1` (
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `STAGE_ID` varchar(34) NOT NULL COMMENT '当前stageId',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_VAR_0` (
  `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_VAR_1` (
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `KEY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '键',
    `VALUE` varchar(4000) DEFAULT NULL COMMENT '值',
    `PROJECT_ID` varchar(64) DEFAULT NULL COMMENT '项目ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_FAVOR_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_FAVOR_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(64) NOT NULL COMMENT '流水线ID',
    `CREATE_TIME` datetime NOT NULL COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_GROUP_0` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_GROUP_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(32) NOT NULL COMMENT '项目ID',
    `NAME` varchar(64) NOT NULL COMMENT '名称',
    `CREATE_TIME` datetime NOT NULL COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_INFO_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_INFO_1` (
    `PIPELINE_ID` varchar(34) NOT NULL DEFAULT '' COMMENT '流水线ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `PIPELINE_NAME` varchar(255) NOT NULL COMMENT '流水线名称',
    `PIPELINE_DESC` varchar(255) DEFAULT NULL COMMENT '流水线描述',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_JOB_MUTEX_GROUP_0` (
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_JOB_MUTEX_GROUP_1` (
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `JOB_MUTEX_GROUP_NAME` varchar(127) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'Job互斥组名字',
    PRIMARY KEY (`PROJECT_ID`,`JOB_MUTEX_GROUP_NAME`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='';
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_LABEL_0` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_LABEL_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `GROUP_ID` bigint(20) NOT NULL COMMENT '用户组ID',
    `NAME` varchar(64) NOT NULL COMMENT '名称',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_LABEL_PIPELINE_0` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_LABEL_PIPELINE_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `LABEL_ID` bigint(20) NOT NULL COMMENT '标签ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_MODEL_TASK_0` (
  `PIPELINE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '流水线ID',
  `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
  `STAGE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '当前stageId',
  `CONTAINER_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '构建容器ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_MODEL_TASK_1` (
    `PIPELINE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '流水线ID',
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
    `STAGE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '当前stageId',
    `CONTAINER_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '构建容器ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_RESOURCE_0` (
  `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_RESOURCE_1` (
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `VERSION` int(11) NOT NULL DEFAULT '1' COMMENT '版本号',
    `MODEL` mediumtext COMMENT '流水线模型',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_SETTING_0` (
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_SETTING_1` (
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `DESC` varchar(1024) DEFAULT NULL COMMENT '描述',
    `RUN_TYPE` int(11) DEFAULT NULL COMMENT '',
    `NAME` varchar(255) DEFAULT NULL COMMENT '名称',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TRIGGER_REVIEW_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TRIGGER_REVIEW_1` (
    `BUILD_ID` varchar(34) NOT NULL DEFAULT '' COMMENT '构建ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL DEFAULT '' COMMENT '流水线ID',
    `TRIGGER_REVIEWER` text NOT NULL COMMENT '触发审核人列表',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_0` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `PROJECT_ID` varchar(32) NOT NULL COMMENT '项目ID',
  `NAME` varchar(64) NOT NULL COMMENT '名称',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(32) NOT NULL COMMENT '项目ID',
    `NAME` varchar(64) NOT NULL COMMENT '名称',
    `FILTER_BY_PIPEINE_NAME` varchar(128) DEFAULT '' COMMENT '流水线名称过滤器,已废弃,统一到filters管理',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_GROUP_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_GROUP_1` (
    `ID` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `VIEW_ID` bigint NOT NULL COMMENT '流水线组ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_TOP_0` (
  `ID` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
  `VIEW_ID` bigint NOT NULL COMMENT '流水线组ID',
  `CREATOR` varchar(64) NOT NULL COMMENT '创建者',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_TOP_1` (
    `ID` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `VIEW_ID` bigint NOT NULL COMMENT '流水线组ID',
    `CREATOR` varchar(64) NOT NULL COMMENT '创建者',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_USER_LAST_VIEW_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_USER_LAST_VIEW_1` (
    `USER_ID` varchar(32) NOT NULL COMMENT '用户ID',
    `PROJECT_ID` varchar(32) NOT NULL COMMENT '项目ID',
    `VIEW_ID` varchar(64) NOT NULL COMMENT '视图ID',
    `CREATE_TIME` datetime NOT NULL COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_USER_SETTINGS_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_VIEW_USER_SETTINGS_1` (
    `USER_ID` varchar(255) NOT NULL COMMENT '用户ID',
    `PROJECT_ID` varchar(32) NOT NULL COMMENT '项目ID',
    `SETTINGS` mediumtext NOT NULL COMMENT '属性配置表',
    `CREATE_TIME` datetime NOT NULL COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `T_REPORT_0` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `PROJECT_ID` varchar(32) NOT NULL COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
  `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
...
CREATE TABLE IF NOT EXISTS `T_REPORT_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(32) NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
...
CREATE TABLE IF NOT EXISTS `T_TEMPLATE_0` (
...
CREATE TABLE IF NOT EXISTS `T_TEMPLATE_1` (
    `VERSION` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `ID` varchar(32) NOT NULL COMMENT '主键ID',
    `TEMPLATE_NAME` varchar(64) NOT NULL COMMENT '模板名称',
    `PROJECT_ID` varchar(34) NOT NULL COMMENT '项目ID',
...
CREATE TABLE IF NOT EXISTS `T_TEMPLATE_PIPELINE_0` (
  `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
...
CREATE TABLE IF NOT EXISTS `T_TEMPLATE_PIPELINE_1` (
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `INSTANCE_TYPE` VARCHAR(32) NOT NULL DEFAULT 'CONSTRAINT' COMMENT '实例化类型：FREEDOM 自由模式  CONSTRAINT 约束模式',
    `ROOT_TEMPLATE_ID` VARCHAR(32) NULL COMMENT '源模板ID',
...
CREATE TABLE IF NOT EXISTS `T_PROJECT_PIPELINE_CALLBACK_0` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
...
CREATE TABLE IF NOT EXISTS `T_PROJECT_PIPELINE_CALLBACK_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `EVENTS` varchar(255) DEFAULT NULL COMMENT '事件',
    `CALLBACK_URL` varchar(255) NOT NULL COMMENT '回调url地址',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_HIS_DATA_CLEAR_0` (
  `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_HIS_DATA_CLEAR_1` (
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `DEL_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_PAUSE_VALUE_0` (
  `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
  `TASK_ID` varchar(34) NOT NULL COMMENT '任务ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_PAUSE_VALUE_1` (
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `TASK_ID` varchar(34) NOT NULL COMMENT '任务ID',
    `DEFAULT_VALUE` text COMMENT '默认变量',
...
CREATE TABLE IF NOT EXISTS `T_PROJECT_PIPELINE_CALLBACK_HISTORY_0` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
  `EVENTS` VARCHAR(255) DEFAULT NULL COMMENT '事件',
  `CALLBACK_URL` VARCHAR(255) NOT NULL COMMENT '回调url地址',
...
CREATE TABLE IF NOT EXISTS `T_PROJECT_PIPELINE_CALLBACK_HISTORY_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `EVENTS` VARCHAR(255) DEFAULT NULL COMMENT '事件',
    `CALLBACK_URL` VARCHAR(255) NOT NULL COMMENT '回调url地址',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_WEBHOOK_QUEUE_0` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
  `PIPELINE_ID` VARCHAR(64) NOT NULL COMMENT '流水线ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_WEBHOOK_QUEUE_1` (
    `ID` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `PIPELINE_ID` VARCHAR(64) NOT NULL COMMENT '流水线ID',
    `SOURCE_PROJECT_ID` BIGINT(20) NOT NULL COMMENT '源项目ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_RESOURCE_VERSION_0` (
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `VERSION` int(11) NOT NULL DEFAULT '1' COMMENT '版本号',
    `VERSION_NAME` varchar(64) NOT NULL COMMENT '版本名称',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_RESOURCE_VERSION_1` (
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `VERSION` int(11) NOT NULL DEFAULT '1' COMMENT '版本号',
    `VERSION_NAME` varchar(64) NOT NULL COMMENT '版本名称',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_SETTING_VERSION_0` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `SUCCESS_RECEIVER` mediumtext COMMENT '成功接受者',
    `FAIL_RECEIVER` mediumtext COMMENT '失败接受者',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_SETTING_VERSION_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `SUCCESS_RECEIVER` mediumtext COMMENT '成功接受者',
    `FAIL_RECEIVER` mediumtext COMMENT '失败接受者',
...
CREATE TABLE IF NOT EXISTS `T_AUDIT_RESOURCE_0` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
CREATE TABLE IF NOT EXISTS `T_AUDIT_RESOURCE_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `RESOURCE_TYPE` varchar(32) NOT NULL COMMENT '资源类型',
    `RESOURCE_ID` varchar(128) NOT NULL COMMENT '资源ID',
    `RESOURCE_NAME` varchar(128) NOT NULL COMMENT '资源名称',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_DATA_CLEAR_0` (
  `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
  `DEL_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '',
  PRIMARY KEY (`PIPELINE_ID`)
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_DATA_CLEAR_1` (
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `DEL_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '',
    PRIMARY KEY (`PIPELINE_ID`)
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_TEMPLATE_ACROSS_INFO_0`  (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_TEMPLATE_ACROSS_INFO_1`  (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `TEMPLATE_ID` char(34) NOT NULL COMMENT '模板唯一UUID',
    `PROJECT_ID` varchar(64)  NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(34)  NOT NULL COMMENT '流水线ID （P-32位UUID)=34位',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_COMMITS_0` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_COMMITS_1` (
    `ID` bigint(20) NOT NULL AUTO_INCREMENT,
    `PROJECT_ID` varchar(32) NOT NULL,
    `PIPELINE_ID` varchar(34) NOT NULL,
    `BUILD_ID` varchar(34) NOT NULL,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `T_PIPELINE_WEBHOOK_BUILD_PARAMETER_0` (
	`BUILD_ID` varchar(34) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_WEBHOOK_BUILD_PARAMETER_1` (
    `BUILD_ID` varchar(34) NOT NULL,
    `PROJECT_ID` varchar(64) NOT NULL,
    `PIPELINE_ID` varchar(34) NOT NULL,
    `BUILD_PARAMETERS` text,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `T_PIPELINE_RECENT_USE_0` (
  `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_RECENT_USE_1` (
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `USER_ID` varchar(64) NOT NULL COMMENT '用户ID',
    `PIPELINE_ID` varchar(64) NOT NULL COMMENT '流水线ID',
    `USE_TIME` datetime NOT NULL COMMENT '使用时间',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_RECORD_CONTAINER_0` (
    `BUILD_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '构建ID',
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '流水线ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_RECORD_CONTAINER_1` (
    `BUILD_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '构建ID',
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '流水线ID',
    `RESOURCE_VERSION` int(11) NOT NULL COMMENT '编排版本',
...
CREATE TABLE IF NOT EXISTS  `T_PIPELINE_BUILD_RECORD_MODEL_0` (
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
...
CREATE TABLE IF NOT EXISTS  `T_PIPELINE_BUILD_RECORD_MODEL_1` (
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `PROJECT_ID` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL DEFAULT '' COMMENT '流水线ID',
    `RESOURCE_VERSION` int(11) NOT NULL COMMENT '编排版本',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_RECORD_STAGE_0` (
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_RECORD_STAGE_1` (
    `BUILD_ID` varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '构建ID',
    `PROJECT_ID` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '项目ID',
    `PIPELINE_ID` varchar(64) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '流水线ID',
    `RESOURCE_VERSION` int(11) DEFAULT NULL COMMENT '编排版本号',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_RECORD_TASK_0` (
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_BUILD_RECORD_TASK_1` (
    `BUILD_ID` varchar(34) NOT NULL COMMENT '构建ID',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `PIPELINE_ID` varchar(34) NOT NULL COMMENT '流水线ID',
    `RESOURCE_VERSION` int(11) NOT NULL COMMENT '编排版本号',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TRIGGER_EVENT_0`
(
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TRIGGER_EVENT_1`
(
    `REQUEST_ID`      varchar(64)  NOT NULL COMMENT '请求ID',
    `PROJECT_ID`      varchar(64)  NOT NULL COMMENT '项目ID',
    `EVENT_ID`        bigint(20)   NOT NULL COMMENT '事件ID',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TRIGGER_DETAIL_0`
(
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TRIGGER_DETAIL_1`
(
    `DETAIL_ID`      bigint(20)  NOT NULL COMMENT '事件明细ID',
    `PROJECT_ID`     varchar(64) NOT NULL COMMENT '项目ID',
    `EVENT_ID`       bigint(20)  NOT NULL COMMENT '事件ID',
