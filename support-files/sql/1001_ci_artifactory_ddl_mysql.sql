...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_ARTIFACT_INFO` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNI_INX_TPAI_BUILD_EXEC_TASK_ARTIFACT` (`BUILD_ID`, `EXECUTE_COUNT`, `TASK_ID`, `ARTIFACT_TYPE`, `ARTIFACT_NAME`, `ARTIFACT_VERSION`),
  KEY `INX_TPAI_PROJECT_TYPE_NAME_VERSION_CT` (`PROJECT_ID`, `ARTIFACT_TYPE`, `ARTIFACT_NAME`, `ARTIFACT_VERSION`, `CREATE_TIME`),
  KEY `INX_TPAI_PROJECT_PIPELINE_BUILD` (`PROJECT_ID`, `PIPELINE_ID`, `CREATE_TIME`),
