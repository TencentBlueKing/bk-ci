...
BEGIN
    ...
    IF NOT EXISTS(SELECT 1
        ...
        CREATE TABLE T_PIPELINE_WEBHOOK_BAK_NEED_DEL SELECT * FROM T_PIPELINE_WEBHOOK;
        TRUNCATE TABLE T_PIPELINE_WEBHOOK;
        ALTER TABLE T_PIPELINE_WEBHOOK ADD UNIQUE INDEX `UNIQ_KEY` (`PIPELINE_ID`, `REPO_HASH_ID`);
        INSERT IGNORE INTO T_PIPELINE_WEBHOOK SELECT * FROM T_PIPELINE_WEBHOOK_BAK_NEED_DEL;
