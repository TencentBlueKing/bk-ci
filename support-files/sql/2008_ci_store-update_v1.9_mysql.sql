...
BEGIN
    ...
    ALTER TABLE devops_store.T_STORE_ERROR_CODE_INFO MODIFY COLUMN STORE_CODE varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商店代码';
    END IF;
    ...
    ALTER TABLE devops_store.T_STORE_ERROR_CODE_INFO ADD ERROR_CODE_TYPE tinyint(4) DEFAULT 0 NOT NULL COMMENT '错误码所属类型 0:组件，1：第三方平台，2：通用';
    END IF;
