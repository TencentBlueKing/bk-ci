...
CREATE TABLE `T_PIPELINE_OVERVIEW_DATA` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNI_TPOD_PROJECT_TIME_PIPELINE` (`PROJECT_ID`, `STATISTICS_TIME`, `PIPELINE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='流水线数据概览表';

CREATE TABLE `T_PIPELINE_STAGE_OVERVIEW_DATA` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL  COMMENT '流水线ID',
  `PIPELINE_NAME` varchar(255) NOT NULL COMMENT '流水线名称',
  ...
  `CREATE_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNI_TPSOD_PROJECT_TIME_PIPELINE_TAG` (`PROJECT_ID`, `STATISTICS_TIME`, `PIPELINE_ID`, `STAGE_TAG_NAME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='流水线stage数据概览表';

CREATE TABLE `T_PIPELINE_FAIL_SUMMARY_DATA` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL  COMMENT '流水线ID',
  `PIPELINE_NAME` varchar(255) NOT NULL COMMENT '流水线名称',
  ...
  `CREATE_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNI_TPFSD_PROJECT_TIME_PIPELINE_TYPE` (`PROJECT_ID`, `STATISTICS_TIME`, `PIPELINE_ID`, `ERROR_TYPE`),
...
CREATE TABLE `T_PIPELINE_FAIL_DETAIL_DATA` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL  COMMENT '流水线ID',
  `PIPELINE_NAME` varchar(255) NOT NULL COMMENT '流水线名称',
...
CREATE TABLE `T_ATOM_OVERVIEW_DATA` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL  COMMENT '流水线ID',
  `PIPELINE_NAME` varchar(255) NOT NULL COMMENT '流水线名称',
  ...
  `CREATE_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNI_TAOD_PROJECT_TIME_PIPELINE_ATOM` (`PROJECT_ID`, `STATISTICS_TIME`, `PIPELINE_ID`, `ATOM_CODE`),
  KEY  `INX_TAOD_PROJECT_TIME_ATOM` (`PROJECT_ID`, `STATISTICS_TIME`, `ATOM_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='插件数据概览表';

CREATE TABLE `T_ATOM_FAIL_SUMMARY_DATA` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL  COMMENT '流水线ID',
  `PIPELINE_NAME` varchar(255) NOT NULL COMMENT '流水线名称',
  ...
  `CREATE_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNI_TAFSD_PROJECT_TIME_PIPELINE_TYPE_CODE` (`PROJECT_ID`, `STATISTICS_TIME`, `PIPELINE_ID`, `ERROR_TYPE`, `ATOM_CODE`),
...
CREATE TABLE `T_ATOM_FAIL_DETAIL_DATA` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL  COMMENT '流水线ID',
  `PIPELINE_NAME` varchar(255) NOT NULL COMMENT '流水线名称',
...
CREATE TABLE `T_PROJECT_THIRD_PLATFORM_DATA` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
...
CREATE TABLE `T_PROJECT_PIPELINE_LABEL_INFO` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
  `PIPELINE_ID` varchar(34) NOT NULL  COMMENT '流水线ID',
  ...
  KEY  `INX_TPPLI_PIPELINE_LABEL` (`PIPELINE_ID`, `LABEL_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='流水线标签信息';

CREATE TABLE `T_ATOM_DISPLAY_CONFIG` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `PROJECT_ID` varchar(64) NOT NULL  COMMENT '项目ID',
  `ATOM_CODE` varchar(64) NOT NULL COMMENT '插件代码',
  `ATOM_NAME` varchar(64) NOT NULL COMMENT '插件名称',
...
CREATE TABLE `T_ERROR_TYPE_DICT` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
...
CREATE TABLE `T_ERROR_CODE_INFO` (
  `ID` bigint(32) NOT NULL  COMMENT '主键ID',
  `ERROR_TYPE` int(11) NOT NULL COMMENT '错误类型',
  ...
  `CREATE_TIME` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNI_TECI_TYPE_CODE` (`ERROR_TYPE`, `ERROR_CODE`),
  KEY `UNI_TECI_CODE` (`ERROR_CODE`)
