...
BEGIN
    ...
    ALTER TABLE T_STORE_DOCKING_PLATFORM ADD COLUMN `ERROR_CODE_PREFIX` int(3) DEFAULT NULL COMMENT '平台所属错误码前缀';
    END IF;
    ...
    ALTER TABLE T_STORE_DOCKING_PLATFORM ADD UNIQUE INDEX `UNI_INX_TSDP_PLATFORM_ERROR` (ERROR_CODE_PREFIX);
    END IF;
