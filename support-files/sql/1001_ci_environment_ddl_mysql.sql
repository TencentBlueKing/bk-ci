...
CREATE TABLE IF NOT EXISTS `T_NODE_TAG_KEY` (
	...
	CONSTRAINT T_NODE_TAG_KEY_UNIQUE UNIQUE KEY (KEY_NAME)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS `T_NODE_TAG_VALUES` (
	`ID` bigint(20) auto_increment NOT NULL PRIMARY KEY,
	`TAG_KEY_ID` bigint(20) NOT NULL COMMENT '标签名ID',
	`VALUE_NAME` varchar(255) NOT NULL COMMENT '标签值',
	CONSTRAINT T_NODE_TAG_VALUES_UNIQUE UNIQUE KEY (TAG_KEY_ID,VALUE_NAME)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
