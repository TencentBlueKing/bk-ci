...
CREATE TABLE IF NOT EXISTS `T_NODE` (
  ...
  KEY `NODE_TYPE` (`LAST_MODIFY_TIME`),
  KEY `NODE_STATUS` (`NODE_STATUS`,`NODE_TYPE`),
  KEY `IDX_HOST` (`HOST_ID`,`PROJECT_ID`),
  KEY `IDX_TYPE` (`NODE_TYPE`,`HOST_ID`)
...
CREATE TABLE IF NOT EXISTS `T_AGENT_SHARE_PROJECT`  (
  ...
  `MAIN_PROJECT_ID` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '主项目ID',
  `SHARED_PROJECT_ID` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '共享的目标项目ID',
