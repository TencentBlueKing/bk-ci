### 请求方法/请求路径
#### GET /{apigwType}/v4/projects/{projectId}/pipelineView/listViewPipelines
### 资源描述
#### 用户获取视图(流水线组)流水线编排列表
### 输入参数说明
#### Path参数
...
| HTTP代码  | 参数类型                                                                              | 说明               |
| ------- | --------------------------------------------------------------------------------- | ---------------- |
| default | [ResultPipelineViewPipelinePagePipeline](#ResultPipelineViewPipelinePagePipeline) | default response |

### Curl 请求样例

```Json
curl -X GET '[请替换为上方API地址栏请求地址]?collation={collation}&filterByCreator={filterByCreator}&filterByLabels={filterByLabels}&filterByPipelineName={filterByPipelineName}&filterByViewIds={filterByViewIds}&isProject={isProject}&page={page}&pageSize={pageSize}&showDelete={showDelete}&sortType={sortType}&viewId={viewId}&viewName={viewName}' \
...
```Json
{
  "data" : {
    ...
    "records" : [ {
      ...
      "latestBuildEstimatedExecutionSeconds" : 0,
      "latestBuildId" : "",
      "latestBuildNum" : 0,
      "latestBuildNumAlias" : "",
...
### 相关模型数据
#### ResultPipelineViewPipelinePagePipeline
##### 数据返回包装模型

| 参数名称    | 参数类型                                                                  | 必须  | 参数说明 |
| ------- | --------------------------------------------------------------------- | --- | ---- |
| data    | [PipelineViewPipelinePagePipeline](#PipelineViewPipelinePagePipeline) |     |      |
| message | string                                                                |     | 错误信息 |
| status  | integer                                                               | √   | 状态码  |

#### PipelineViewPipelinePagePipeline
##### Pipeline分页数据包装模型
...
| records    | List<[Pipeline](#Pipeline)> | √   | 数据    |
...
| 参数名称                                 | 参数类型                                                                                                                                                                                                                                                                                                                                                                                         | 必须  | 参数说明                      |
| ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- | ------------------------- |
| archivingFlag                        | boolean                                                                                                                                                                                                                                                                                                                                                                                      |     | 是否处于归档中                   |
| buildCount                           | integer                                                                                                                                                                                                                                                                                                                                                                                      | √   | 构建次数                      |
| buildNumRule                         | string                                                                                                                                                                                                                                                                                                                                                                                       |     | 自定义构建号规则                  |
| canManualStartup                     | boolean                                                                                                                                                                                                                                                                                                                                                                                      | √   | 是否可手工启动                   |
| createTime                           | integer                                                                                                                                                                                                                                                                                                                                                                                      | √   | 流水线创建时间                   |
| creator                              | string                                                                                                                                                                                                                                                                                                                                                                                       | √   | 流水线创建人                    |
| currentTimestamp                     | integer                                                                                                                                                                                                                                                                                                                                                                                      | √   | 服务器当前时间戳                  |
| delete                               | boolean                                                                                                                                                                                                                                                                                                                                                                                      |     | 是否已删除                     |
| deploymentTime                       | integer                                                                                                                                                                                                                                                                                                                                                                                      | √   | 部署时间                      |
| groupLabel                           | List<[PipelineGroupLabels](#PipelineGroupLabels)>                                                                                                                                                                                                                                                                                                                                            |     | 流水线分组和标签                  |
| hasCollect                           | boolean                                                                                                                                                                                                                                                                                                                                                                                      | √   | 是否被收藏                     |
| hasPermission                        | boolean                                                                                                                                                                                                                                                                                                                                                                                      | √   | 是否有list权限                 |
| instanceFromTemplate                 | boolean                                                                                                                                                                                                                                                                                                                                                                                      |     | 是否从模板中实例化出来的              |
| lastBuildFinishCount                 | integer                                                                                                                                                                                                                                                                                                                                                                                      |     | 最后一次构建已完成的任务个数            |
| lastBuildMsg                         | string                                                                                                                                                                                                                                                                                                                                                                                       |     | 最后一次构建的构建信息               |
| lastBuildTotalCount                  | integer                                                                                                                                                                                                                                                                                                                                                                                      |     | 最后一次构建所有的任务个数             |
| latestBuildEndTime                   | integer                                                                                                                                                                                                                                                                                                                                                                                      |     | 最后构建结束时间                  |
| latestBuildEstimatedExecutionSeconds | integer                                                                                                                                                                                                                                                                                                                                                                                      |     | 最后任务预计执行时间（毫秒）            |
| latestBuildId                        | string                                                                                                                                                                                                                                                                                                                                                                                       |     | 最后构建实例ID                  |
| latestBuildNum                       | integer                                                                                                                                                                                                                                                                                                                                                                                      |     | 最后构建版本号                   |
| latestBuildNumAlias                  | string                                                                                                                                                                                                                                                                                                                                                                                       |     | 最后自定义构建版本号                |
...
| updater                              | string                                                                                                                                                                                                                                                                                                                                                                                       | √   | 流水线更新人                    |
| version                              | integer                                                                                                                                                                                                                                                                                                                                                                                      |     | 版本                        |
| versionName                          | string                                                                                                                                                                                                                                                                                                                                                                                       |     | 版本名称                      |
| viewNames                            | List<string>                                                                                                                                                                                                                                                                                                                                                                                 |     | 流水线组名称列表                  |
| webhookAliasName                     | string                                                                                                                                                                                                                                                                                                                                                                                       |     | webhook仓库别名               |
| webhookMessage                       | string                                                                                                                                                                                                                                                                                                                                                                                       |     | webhook提交信息               |
| webhookRepoUrl                       | string                                                                                                                                                                                                                                                                                                                                                                                       |     | webhook仓库地址               |
| webhookType                          | string                                                                                                                                                                                                                                                                                                                                                                                       |     | webhook类型                 |
| yamlExist                            | boolean                                                                                                                                                                                                                                                                                                                                                                                      |     | yaml在默认分支是否存在             |
...
| 参数名称      | 参数类型         | 必须  | 参数说明  |
| --------- | ------------ | --- | ----- |
| groupName | string       | √   | 流水线名字 |
| labelName | List<string> | √   | 标签名字  |
