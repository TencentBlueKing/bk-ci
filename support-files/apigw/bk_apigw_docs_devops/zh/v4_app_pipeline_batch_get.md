### 请求方法/请求路径
#### POST /{apigwType}/v4/projects/{projectId}/pipelines/pipeline_batch_get
### 资源描述
#### 批量获取流水线编排与配置
### 输入参数说明
#### Path参数
...
| 参数名称    | 参数类型         | 必须   |
| ------- | ------------ | ---- |
| 流水线ID列表 | List<string> | true |

#### 响应参数

| HTTP代码  | 参数类型                                      | 说明               |
| ------- | ----------------------------------------- | ---------------- |
| default | [ResultListPipeline](#ResultListPipeline) | default response |
...
| 参数名称    | 参数类型                        | 必须  | 参数说明 |
| ------- | --------------------------- | --- | ---- |
| data    | List<[Pipeline](#Pipeline)> |     | 数据   |
| message | string                      |     | 错误信息 |
| status  | integer                     | √   | 状态码  |
