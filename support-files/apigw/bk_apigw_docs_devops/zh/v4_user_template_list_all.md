### 请求方法/请求路径
#### GET /{apigwType}/v4/projects/{projectId}/templates/all_templates
### 资源描述
#### 获取所有种类流水线模板列表
### 输入参数说明
#### Path参数
...
| HTTP代码  | 参数类型                                                      | 说明               |
| ------- | --------------------------------------------------------- | ---------------- |
| default | [ResultOptionalTemplateList](#ResultOptionalTemplateList) | default response |
...
### 相关模型数据
#### ResultOptionalTemplateList
##### 数据返回包装模型

| 参数名称    | 参数类型                                          | 必须  | 参数说明 |
| ------- | --------------------------------------------- | --- | ---- |
| data    | [OptionalTemplateList](#OptionalTemplateList) |     |      |
| message | string                                        |     | 错误信息 |
| status  | integer                                       | √   | 状态码  |
...
| templates | Map<String, [OptionalTemplate](#OptionalTemplate)> | √   | 模板列表 |
...
| 参数名称                      | 参数类型                                                    | 必须  | 参数说明   |
| ------------------------- | ------------------------------------------------------- | --- | ------ |
| category                  | List<string>                                            | √   | 应用范畴   |
| cloneTemplateSettingExist | [CloneTemplateSettingExist](#CloneTemplateSettingExist) |     |        |
| desc                      | string                                                  |     | 模版描述   |
