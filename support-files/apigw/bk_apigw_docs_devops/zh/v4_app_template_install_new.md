### 请求方法/请求路径
#### POST /{apigwType}/v4/market/template_install_from_store_new
### 资源描述
...
| HTTP代码  | 参数类型                                                              | 说明               |
| ------- | ----------------------------------------------------------------- | ---------------- |
| default | [ResultListPipelineTemplateInfo](#ResultListPipelineTemplateInfo) | default response |
...
#### ResultListPipelineTemplateInfo
##### 数据返回包装模型

| 参数名称    | 参数类型                                                | 必须  | 参数说明 |
| ------- | --------------------------------------------------- | --- | ---- |
| data    | List<[PipelineTemplateInfo](#PipelineTemplateInfo)> |     | 数据   |
| message | string                                              |     | 错误信息 |
| status  | integer                                             | √   | 状态码  |
...
| srcTemplateId      | string                | √   | 父模板ID      |
| srcTemplateVersion | integer               | √   | 父模板版本ID    |
| stages             | List<[Stage](#Stage)> | √   | 阶段集合       |
| templateId         | string                | √   | 模版ID       |
| templateName       | string                | √   | 模版名称，兼容老代码 |
| templateType       | string                | √   | 模板类型       |
| templateTypeDesc   | string                | √   | 模板类型描述     |
| version            | integer               | √   | 当前模板版本ID   |
