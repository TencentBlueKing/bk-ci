### 请求方法/请求路径
#### GET /{apigwType}/v4/projects/{projectId}/pipelines/pipeline_list
### 资源描述
#### 获取项目的流水线列表
### 输入参数说明
#### Path参数
...
| HTTP代码  | 参数类型                                      | 说明               |
| ------- | ----------------------------------------- | ---------------- |
| default | [ResultPagePipeline](#ResultPagePipeline) | default response |
...
| 参数名称    | 参数类型                          | 必须  | 参数说明 |
| ------- | ----------------------------- | --- | ---- |
| data    | [PagePipeline](#PagePipeline) |     |      |
| message | string                        |     | 错误信息 |
| status  | integer                       | √   | 状态码  |
