### 请求方法/请求路径
#### POST /{apigwType}/v4/projects/{projectId}/version/save_draft
### 资源描述
#### 保存或创建流水线编排草稿
### 输入参数说明
#### Path参数
...
| 参数名称     | 参数类型                                                                | 必须   |
| -------- | ------------------------------------------------------------------- | ---- |
| 流水线模型与设置 | [PipelineVersionWithModelRequest](#PipelineVersionWithModelRequest) | true |
...
### 相关模型数据
#### PipelineVersionWithModelRequest
##### 

| 参数名称            | 参数类型                                                | 必须  | 参数说明                   |
| --------------- | --------------------------------------------------- | --- | ---------------------- |
| baseVersion     | integer                                             | √   | 草稿的来源版本（前端保存时传递）       |
| description     | string                                              |     | 版本变更说明                 |
| modelAndSetting | [PipelineModelAndSetting](#PipelineModelAndSetting) | √   |                        |
| pipelineId      | string                                              |     | 流水线ID（为空时导入并创建流水线）     |
| storageType     | ENUM(YAML, MODEL)                                   |     | 存储格式                   |
| yaml            | string                                              |     | 流水线YAML编排（不为空时以YAML为准） |
