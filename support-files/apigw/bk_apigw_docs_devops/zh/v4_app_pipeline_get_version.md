### 请求方法/请求路径
#### GET /{apigwType}/v4/projects/{projectId}/version/get_version
### 资源描述
#### 获取流水线指定版本的两种编排
### 输入参数说明
#### Path参数
...
| HTTP代码  | 参数类型                                                              | 说明               |
| ------- | ----------------------------------------------------------------- | ---------------- |
| default | [ResultPipelineVersionWithModel](#ResultPipelineVersionWithModel) | default response |
...
### 相关模型数据
#### ResultPipelineVersionWithModel
##### 数据返回包装模型

| 参数名称    | 参数类型                                                  | 必须  | 参数说明 |
| ------- | ----------------------------------------------------- | --- | ---- |
| data    | [PipelineVersionWithModel](#PipelineVersionWithModel) |     |      |
| message | string                                                |     | 错误信息 |
| status  | integer                                               | √   | 状态码  |
...
| 参数名称            | 参数类型                                                | 必须  | 参数说明         |
| --------------- | --------------------------------------------------- | --- | ------------ |
| baseVersion     | integer                                             | √   | 该版本的源版本号     |
| baseVersionName | string                                              | √   | 该版本的版本号名     |
| canDebug        | boolean                                             |     | 是否处在可以调试状态   |
| description     | string                                              |     | 版本变更说明       |
| modelAndSetting | [PipelineModelAndSetting](#PipelineModelAndSetting) | √   |              |
| updateTime      | integer                                             | √   | 版本修改时间       |
| updater         | string                                              | √   | 更新操作人        |
| version         | integer                                             | √   | 版本号（流水线唯一递增） |
| versionName     | string                                              | √   | 版本名称         |
| yamlInvalidMsg  | string                                              |     | YAML解析异常信息   |
| yamlPreview     | [PreviewResponse](#PreviewResponse)                 |     |              |
| yamlSupported   | boolean                                             | √   | 是否支持YAML解析   |
