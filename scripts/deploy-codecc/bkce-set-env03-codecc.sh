...
set_env03 BK_CODECC_MONGODB_HOST="$BK_CMDB_MONGODB_HOST" BK_CODECC_MONGODB_PORT="$BK_CMDB_MONGODB_PORT" BK_CODECC_MONGODB_USER=bk_codecc BK_CODECC_MONGODB_PASSWORD="$(random_pass)"
