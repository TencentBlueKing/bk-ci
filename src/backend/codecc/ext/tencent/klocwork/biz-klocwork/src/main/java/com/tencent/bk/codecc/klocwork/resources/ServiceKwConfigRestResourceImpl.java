...
@RestResource
@Slf4j
public class ServiceKwConfigRestResourceImpl implements ServiceKwConfigRestResource
{
    @Autowired
    ...
    {
        return new CodeCCResult<>(kwConfigService.registerProject(registerPlatformProjVO));
    }
}
