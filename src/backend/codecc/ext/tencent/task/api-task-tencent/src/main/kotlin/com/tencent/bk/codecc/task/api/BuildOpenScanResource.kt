...
interface BuildOpenScanResource {
    ...
    fun queryGongfengStatProj(
        ...
        @PathParam("projectId")
        projectId: Int): CodeCCResult<GongfengStatProjVO>
    ...
    @Path("/filter/config")
    @GET
    fun getFilterConfig() : CodeCCResult<Map<String, String>>
    ...
    fun updateCommitId(
        ...
        buildId : String,
        @ApiParam(value = "提交id")
        commitId : String) : CodeCCResult<Boolean>
}