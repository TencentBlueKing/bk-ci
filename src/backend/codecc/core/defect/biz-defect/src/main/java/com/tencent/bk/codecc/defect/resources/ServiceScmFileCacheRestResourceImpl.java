...
public class ServiceScmFileCacheRestResourceImpl implements ServiceScmFileCacheRestResource {
    ...
    @Override
    public CodeCCResult<Map<String, ScmBlameVO>> loadAuthorInfoMap(long taskId, String streamName, String toolName, String buildId) {
        return new CodeCCResult<>(scmFileInfoService.loadAuthorInfoMap(taskId, streamName, toolName, buildId));
    }
}
