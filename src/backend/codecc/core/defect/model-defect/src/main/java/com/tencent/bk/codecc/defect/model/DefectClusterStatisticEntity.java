...
@Data
@Document(collection = "t_defect_cluster_statistic")
@AllArgsConstructor
@NoArgsConstructor
@CompoundIndexes({
        @CompoundIndex(name = "task_id_1_build_id_1_time_1", def = "{'task_id': 1, 'build_id': 1, 'time': 1}")
})
public class DefectClusterStatisticEntity {
    /**
     * 任务ID
     */
    @Field("task_id")
    ...
    @Field("new_defect_change")
    private Integer newDefectCount;

    @Field("fix_defect_count")
    private Integer fixDefectCount;

    @Field("mask_defect_count")
