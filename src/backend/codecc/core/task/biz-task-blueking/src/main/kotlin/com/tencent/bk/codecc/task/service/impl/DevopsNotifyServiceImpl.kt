...
class DevopsNotifyServiceImpl @Autowired constructor(
    ...
    override fun sendMail(
        ...
        with(emailNotifyMessage) {
            ...
            client.get(ServiceNotifyResource::class.java).sendEmailNotify(this)
        }
    }
    ...
    override fun sendRtx(
        ...
        with(rtxNotifyMessage){
            ...
            this.sender = from
            this.title = title
            this.priority = com.tencent.devops.common.notify.enums.EnumNotifyPriority.parse(priority)
            addAllReceivers(receivers)
        }
