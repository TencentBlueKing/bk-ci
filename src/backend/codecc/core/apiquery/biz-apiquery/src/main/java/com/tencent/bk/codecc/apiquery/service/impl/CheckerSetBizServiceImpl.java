...
public class CheckerSetBizServiceImpl implements ICheckerSetBizService
{
     ...
     */
    @Override
    public List<com.tencent.devops.common.api.checkerset.CheckerSetVO> getCheckerSetsByTaskId(Long taskId) {
        // 查出任务维度的id集合
        ...
        return checkerSetModels.stream()
                ...
                .sorted(Comparator.comparingLong(o -> checkerSetCountMap.containsKey(o.getCheckerSetId())
                    ...
                    com.tencent.devops.common.api.checkerset.CheckerSetVO
                            checkerSetVO = new com.tencent.devops.common.api.checkerset.CheckerSetVO();
                    BeanUtils.copyProperties(checkerSetModel, checkerSetVO);
