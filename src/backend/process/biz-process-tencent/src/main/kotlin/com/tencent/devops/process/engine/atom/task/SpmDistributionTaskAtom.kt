    ...
    override fun execute(task: PipelineBuildTask, param: SpmDistributionElement, runVariables: Map<String, String>): AtomResponse {
        ...
        try {
            regexPathsStr.split(",").forEach { regex ->
                ...
                LogUtils.addLine(rabbitTemplate, buildId, "requestBody:$requestBody", elementId, task.executeCount ?: 1)
            ...
            LogUtils.addLine(rabbitTemplate, buildId, "$count file(s) will be distribute...", elementId, task.executeCount ?: 1)
            ...
            LogUtils.addLine(rabbitTemplate, buildId, "Zip file: $zipFile", elementId, task.executeCount ?: 1)
            ...
            if (response["ret"] != 0) {
                ...
                LogUtils.addRedLine(rabbitTemplate, buildId, "分发CDN失败. msg: $msg", elementId, task.executeCount ?: 1)
                return AtomResponse(
            ...
            if (waitForDistribute(rootPath, distributeFile, cmdbAppId, maxRunningMins)) {
                ...
                LogUtils.addLine(rabbitTemplate, buildId, "CDN distribute success.", elementId, task.executeCount ?: 1)
            }

            LogUtils.addLine(rabbitTemplate, buildId, "Distribute to CDN done", elementId, task.executeCount ?: 1)
        } finally {
