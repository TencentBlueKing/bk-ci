...
class MigCDNPushFileTaskAtom @Autowired constructor(
    ...
    override fun execute(
        ...
        LogUtils.addLine(rabbitTemplate, buildId, "开始上传对应文件到CDN...", task.taskId, task.containerHashId,task.executeCount ?: 1)
        ...
        LogUtils.addLine(rabbitTemplate, buildId, "上传对应文件到CDN结束! result=$pushFile", task.taskId, task.containerHashId,task.executeCount ?: 1)
