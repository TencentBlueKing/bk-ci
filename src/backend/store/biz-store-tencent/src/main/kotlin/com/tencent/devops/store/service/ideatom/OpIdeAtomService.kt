...
import com.tencent.devops.model.atom.tables.records.TIdeAtomRecord
...
@Service
class OpIdeAtomService @Autowired constructor(
    ...
    private val logger = LoggerFactory.getLogger(OpIdeAtomService::class.java)
    ...
    private fun changeGitRepositoryVisibility(atomCode: String, userId: String, visibilityLevel: VisibilityLevelEnum): Result<Boolean> {
        ...
        val atomFeatureRecord = marketIdeAtomFeatureDao.getIdeAtomFeature(dslContext, atomCode)!!
        try {
            updateGitRepositoryResult = client.get(ServiceRepositoryResource::class).updateGitCodeRepositoryByProjectName(
                userId,
