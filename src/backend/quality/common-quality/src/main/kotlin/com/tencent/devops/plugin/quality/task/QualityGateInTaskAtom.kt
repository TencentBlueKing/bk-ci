...
class QualityGateInTaskAtom @Autowired constructor(
    ...
    override fun execute(
        ...
        if (checkResult.success) {
            LogUtils.addLine(rabbitTemplate, buildId, "质量红线(准入)检测已通过", elementId, task.executeCount ?: 1)
            ...
            LogUtils.addRedLine(rabbitTemplate, buildId, "质量红线(准入)检测被拦截", elementId, task.executeCount ?: 1)
            ...
            LogUtils.addLine(rabbitTemplate, buildId, "质量红线(准入)待审核!审核人：$auditUsers", elementId, task.executeCount ?: 1)
