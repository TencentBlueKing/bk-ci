...
enum class ErrorCodeEnum(
    ...
    SYSTEM_ERROR(ErrorType.SYSTEM, 2122001, "Dispatcher-devcloud系统错误"),
    NO_IDLE_VM_ERROR(ErrorType.SYSTEM, 2122002, "DEVCLOUD构建机启动失败，没有空闲的构建机"),
    ...
    DEVCLOUD_INTERFACE_TIMEOUT(ErrorType.THIRD_PARTY, 2122018, "第三方服务-DEVCLOUD 异常，异常信息 - 接口请求超时"),
    CREATE_VM_USER_ERROR(ErrorType.USER, 2122003, "第三方服务-DEVCLOUD 异常，异常信息 - 用户操作异常"),

    CREATE_JOB_LIMIT_ERROR(ErrorType.USER, 2122050, "已超过DevCloud创建Job容器上限.")
}
