...
enum class ErrorCodeEnum(
    ...
    SYSTEM_ERROR(ErrorType.SYSTEM, 2133001, "Dispatcher-devcloud系统错误"),
    NO_IDLE_VM_ERROR(ErrorType.SYSTEM, 2133002, "DEVCLOUD构建机启动失败，没有空闲的构建机"),
    CREATE_VM_ERROR(
    ...
    CREATE_VM_INTERFACE_ERROR(
        ErrorType.THIRD_PARTY,
        2133005,
        "第三方服务-DEVCLOUD 异常，异常信息 - 创建容器接口异常"
    ),
    CREATE_VM_INTERFACE_FAIL(
        ErrorType.THIRD_PARTY,
        2133006,
        "第三方服务-DEVCLOUD 异常，异常信息 - 创建容器接口返回失败"
    ),
    OPERATE_VM_INTERFACE_ERROR(
        ErrorType.THIRD_PARTY,
        2133007,
        "第三方服务-DEVCLOUD 异常，异常信息 - 操作容器接口异常"
    ),
    OPERATE_VM_INTERFACE_FAIL(
        ErrorType.THIRD_PARTY,
        2133008,
        "第三方服务-DEVCLOUD 异常，异常信息 - 操作容器接口返回失败"
    ),
    VM_STATUS_INTERFACE_ERROR(
        ErrorType.THIRD_PARTY,
        2133009,
        "第三方服务-DEVCLOUD 异常，异常信息 - 获取容器状态接口异常"
    ),
    CREATE_IMAGE_INTERFACE_ERROR(
        ErrorType.THIRD_PARTY,
        2133010,
        "第三方服务-DEVCLOUD 异常，异常信息 - 创建镜像接口异常"
    ),
    ...
    RETRY_STATUS_FAIL(ErrorType.USER, 2133017, "重试频率过快，请稍后重试"),
