...
class BcsClientCommon {
    ...
    @Value("\${bcs.smartProxy.appId}")
    val bcsAppId: String = ""

    @Value("\${bcs.smartProxy.token}")
    val bcsSmartProxyToken: String = ""

    @Value("\${bcs.smartProxy.smartProxyToken}")
    ...
    fun headers(otherHeaders: Map<String, String>? = null): Headers {
        ...
        //        val smartProxyHeaders = SmartProxyUtil.makeHeaders(
        //            appId = bcsAppId,
        //            token = bcsSmartProxyToken,
        //            staffName = userId,
        //            proxyToken = smartProxyToken
        //        )
        //        result.putAll(smartProxyHeaders)
