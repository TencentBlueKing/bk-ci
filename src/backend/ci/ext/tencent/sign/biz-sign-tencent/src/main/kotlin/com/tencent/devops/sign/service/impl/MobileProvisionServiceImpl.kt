...
import com.tencent.devops.sign.Constants.*
...
class MobileProvisionServiceImpl  @Autowired constructor(
    ...
    override fun downloadMobileProvision(mobileProvisionDir: File, projectId: String, mobileProvisionId: String): File {
        ...
        OkhttpUtils.doGet(url, headers).use { resp ->
            ...
            val decryptedMobileProvisionDecrypt = AESUtil.decrypt(keyStoreAuthSecret, resp.body().toString())
            mobileProvisionFile.writeBytes(decryptedMobileProvisionDecrypt.toByteArray())
        }
