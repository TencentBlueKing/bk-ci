...
import com.tencent.devops.common.kafka.KafkaTopic.BUILD_ATOM_ATOM_METRICS_TOPIC_PREFIX
...
class BuildAtomMetricsResourceImpl @Autowired constructor(
    ...
    override fun reportAtomMetrics(atomCode: String, data: String): Result<Boolean> {
        kafkaClient.send(topic = "$BUILD_ATOM_ATOM_METRICS_TOPIC_PREFIX-$atomCode", msg = data)
        return Result(true)
    }
}
