...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("org.springframework.cloud:spring-cloud-stream:${Versions.CloudStream}")
            dependency("org.springframework.cloud:spring-cloud-stream-binder-kafka:${Versions.CloudStream}")
            dependency("org.springframework.cloud:spring-cloud-stream-binder-rabbit:${Versions.CloudStream}")
