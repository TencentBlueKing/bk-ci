...
object AuthI18nConstants {
    ...
    const val BK_PROJECT_KPI_PRODUCT = "bkProjectKpiProduct" // 项目所属KPI产品
    ...
    const val BK_USER_NOT_IN_PROJECT_SUBJECT_SCOPES = "bkUserNotInProjectSubjectScopes" // 用户不在项目最大授权范围内
