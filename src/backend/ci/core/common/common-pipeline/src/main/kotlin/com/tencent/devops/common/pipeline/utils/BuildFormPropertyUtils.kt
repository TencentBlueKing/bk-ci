...
object BuildFormPropertyUtils {
    fun getCascadeVariable(key: String, type: BuildFormPropertyType) = when (type) {
     ...
     */
    fun getCascadeVariableSubKey(key: String, type: BuildFormPropertyType) = when (type) {
        BuildFormPropertyType.REPO_REF -> {
            listOf(
