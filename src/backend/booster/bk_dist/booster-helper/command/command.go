...
const (
	...
	FlagDay            = "within_days"
	FlagUpScope        = "up_scope"
	FlagLowScope       = "low_scope"
...
var (
	...
	getstatsFlags = []commandCli.Flag{
		...
		commandCli.StringFlag{
			Name:  "up_scope, us",
			Usage: "a scope to judge wheather request cpu is too little",
		},
		commandCli.StringFlag{
			Name:  "low_scope, ls",
			Usage: "a scope to judge wheather request cpu is too much",
		},
		commandCli.BoolFlag{
			Name:  "all, a",
