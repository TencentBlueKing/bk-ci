...
class UserCertResourceImpl @Autowired constructor(
    ...
    override fun hasCreatePermission(userId: String, projectId: String): Result<Boolean> {
        return Result(certService.hasCreatePermission(userId, projectId))
    }
...
//            ,isCommonEnterprise: Boolean?
        ...
        val pageSizeNotNull = pageSize ?: 20
        val limit = PageUtil.convertPageSizeToSQLLimit(pageNotNull, pageSizeNotNull)
        val result = certService.hasPermissionList(userId, projectId, certType, bkAuthPermission, limit.offset, limit.limit)
