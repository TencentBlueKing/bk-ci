...
$BUILD_FLAGS = "-ldflags=`"-w -s -X github.com/TencentBlueKing/bk-ci/agent/src/pkg/config.BuildTime=$BuildTime -X github.com/TencentBlueKing/bk-ci/agent/src/pkg/config.GitCommit=$GitCommit`""
