...
func (n *Netstat) Gather() ([]Metric, error) {
	...
	return []Metric{{
		...
		Fields: map[string]interface{}{
			FieldTCPEstablished: tcpEstablished,
			FieldTCPSynSent:     tcpSynSent,
			FieldTCPSynRecv:     tcpSynRecv,
			FieldTCPFinWait1:    tcpFinWait1,
			FieldTCPFinWait2:    tcpFinWait2,
			FieldTCPTimeWait:    tcpTimeWait,
			FieldTCPClose:       tcpClose,
			FieldTCPCloseWait:   tcpCloseWait,
			FieldTCPLastAck:     tcpLastAck,
			FieldTCPListen:      tcpListen,
			FieldTCPClosing:     tcpClosing,
