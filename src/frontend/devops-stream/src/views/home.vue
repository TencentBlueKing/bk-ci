                ...
                <div class="feature-block ltr">
                    <div class="feature-block--copy">
                        ...
                        <div class="section--sub">
                            ...
                            <p>在 Stream 中，你可以通过<em>uses</em>关键字方便引入这些插件，让插件生态得以最大化利用。<a :href="`http://${DEVOPS_HOST}/console/store/market/list?features=&sortType=RECENT_EXECUTE_NUM&pipeType=atom`" target="_blank">
                                点击浏览所有腾讯CI插件
                            </a></p>
                        </div>
