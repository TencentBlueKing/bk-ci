<template>
    <div class="vs-list-wrapper">
        ...
        >
                ...
                >
                    <bk-table-column label="文件名（版本号）">
                        <template slot-scope="props">
                            <span
                                :title="props.row.fileName + '（' + props.row.version + '）'"
                                class="primary-color"
                            >{{ props.row.fileName }}（{{ props.row.version }}）</span>
                        </template>
                    </bk-table-column>
                    ...
                    <bk-table-column
                        label="大小"
                        prop="fileSize"
                        :formatter="localCoverSize"
                        width="150"
                    ></bk-table-column>
                    <bk-table-column
                        label="开始时间"
                        prop="createTime"
                        :formatter="localConvertTime"
                    ></bk-table-column>
                    <bk-table-column
                        label="执行人"
                        prop="creator"
            ...
            <empty-data
                v-if="showContent && !vsList.length"
