...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const { searchKeyword, searchMatches, currentMatchIndex, prevMatch, nextMatch } = useLogSearch({
    ...
    const renderSettingContent = () => {
      if (!props.element) {
        return <div class={styles.settingPlaceholder}>{t('flow.log.settingPlaceholder')}</div>
      }
