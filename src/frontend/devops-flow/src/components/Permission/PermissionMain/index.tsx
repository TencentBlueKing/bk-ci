  ...
  setup(props) {
    ...
    const initStatus = async () => {
      ...
      try {
        ...
        if (
          code &&
          [ERROR_CODES.NOT_FOUND, ERROR_CODES.FORBIDDEN, ERROR_CODES.SPECIAL_ERROR].includes(code)
        ) {
    ...
    return () => (
      <article class={styles.permissionWrapper} v-bkLoading={{ loading: isLoading.value }}>
