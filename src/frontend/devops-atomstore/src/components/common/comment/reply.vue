    ...
    export default {
        ...
        methods: {
            ...
            expandReplys () {
                ...
                if (!Object.hasOwnProperty.call(this.funObj.expandReplys, type) || typeof this.funObj.expandReplys[type] !== 'function') {
            ...
            priase () {
                ...
                if (!Object.hasOwnProperty.call(this.funObj.priase, type) || typeof this.funObj.priase[type] !== 'function') {
                    this.$bkMessage({ message: this.$t('store.typeError'), theme: 'error' })
                    return
                }
