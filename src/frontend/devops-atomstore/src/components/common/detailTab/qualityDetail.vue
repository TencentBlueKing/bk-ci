<template>
    <section class="tab-content">
        <bk-table :data="qualityData" v-bkloading="{ isLoading }" key="qualityTable">
            ...
            <bk-table-column :label="$t('store.值类型')" prop="thresholdType" show-overflow-tooltip width="200"></bk-table-column>
            <bk-table-column :label="$t('store.支持的操作')" prop="operationList" show-overflow-tooltip :formatter="operationFormatter" width="600"></bk-table-column>
        </bk-table>
    </section>
</template>
