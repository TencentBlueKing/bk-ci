        ...
        <main class="detail-main">
            ...
            <section class="version-content" v-if="!isLoading">
                ...
                >
                    ...
                    <bk-table-column label="状态" prop="imageStatus" :formatter="statusFormatter"></bk-table-column>
                    <bk-table-column label="创建人" prop="creator"></bk-table-column>
                    <bk-table-column label="创建时间" prop="createTime" :formatter="convertTime"></bk-table-column>
