...
class BlueShieldWebSocket {
    ...
    connect () {
        const socket = new SockJS(`${window.PUBLIC_URL_PREFIX}/websocket/ws/user?sessionId=${this.uuid}`)
    ...
    closePageDisConnect () {
        window.addEventListener('beforeunload', (event = {}) => {
            ...
            // a标签也会触发这个事件，需要屏蔽
            if (tagName === 'A') return
            navigator.sendBeacon(`${window.PUBLIC_URL_PREFIX}/websocket/api/user/websocket/sessions/${this.uuid}/userIds/${this.userName}/clear`)
