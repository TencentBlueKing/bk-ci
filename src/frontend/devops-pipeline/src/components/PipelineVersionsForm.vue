        ...
        <form class="bk-form" ref="versionParamsForm" onsubmit="return false;">
            ...
            <div class="params-flex-col">
                <form-field :required="true" :label="$t('buildNum')" :is-error="errors.has(&quot;buildNo&quot;)" :error-msg="errors.first(&quot;buildNo&quot;)">
                    <vuex-input :disabled="isPreview && buildNo.buildNoType !== 'CONSISTENT'" input-type="number" name="buildNo" placeholder="BuildNo" v-validate.initial="&quot;required|numeric&quot;" :value="buildNo.buildNo" :handle-change="handleBuildNoChange" />
                </form-field>
