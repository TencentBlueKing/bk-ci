                    ...
                    >
                        <div class="notice-tab">
                            ...
                            <div class="bk-form-item item-notice">
                                ...
                                <div class="bk-form-content">
                                    <span class="notify-setting-no-data" v-if="!projectGroupAndUsers.length">{{$t('noData')}}</span>
                                    <bk-checkbox-group v-else :value="pipelineSubscription.groups" @change="handleSwitch">
                                        <bk-checkbox v-for="item in projectGroupAndUsers" :key="item.value" :value="item.groupId">
                                            {{ item.groupName }}
