    ...
    export default {
        ...
        methods: {
            ...
            copyAsTemplateInstance (pipeline) {
                ...
                window.top.location.href = `${location.origin}${window.getRoutePrefix()}/pipeline/${projectId}/template/${templateId}/createInstance/${templateVersion}/${pipelineName}?pipelineId=${pipelineId}`
            },
            afterRemovePipeline () {
                this.$router.push({
