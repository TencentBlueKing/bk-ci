...
export const PipelineCopyStrategy = {
    ...
    BUILD_ENV_CREATE_AND_REUSE_SAME_NAME_NODE: 'BUILD_ENV_CREATE_AND_REUSE_SAME_NAME_NODE',   // 新建环境并复用同名节点
    ...
    DEPLOY_ENV_CREATE_AND_REUSE_SAME_NAME_NODE: 'DEPLOY_ENV_CREATE_AND_REUSE_SAME_NAME_NODE',   // 新建部署环境并复用同名节点
