...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             * @param {Object} data 项目对象数据
             */
            // selected (projectId, data) {
            //     const routeName = this.$route.name
            //
            //     // 这么做是因为如果在总览页面或者节点列表页面或者节点详情页面时，切换项目的时候，新切换的项目可能会没有当前的 clusterId
            //     console.log(this.$route.$params.buildNo, routeName)
            //     if (this.$route.$params.buildNo) {
            //         this.$router.push({
            //             name: `${this.subSystemName}List`,
            //             params: {
