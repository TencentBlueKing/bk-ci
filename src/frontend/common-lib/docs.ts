...
export const BkciDocs = {
    ...
    TURBO_GUIDE_DOC: `${turboPrefix}/产品白皮书/Quickstart/linux_c_cpp.md`, // turbo指引文档
    EXT_GUIDE_DOC: `${commonPrefix}/pages/viewpage.action?pageId=103523086`, // 扩展指引文档
    SPAN_NODE_DESC_LINK: `${commonPrefix}/p/1083624634`, // 跨节点描述文档
}
