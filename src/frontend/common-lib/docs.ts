...
export const BkciDocs = {
    ...
    PLUGIN_SPECIFICATE_DOC: `${DOCS_URL_PREFIX}/docs/markdown/ZH/Devops/UserGuide/Developer/plugins/plugin-dev-standard/plugin-specification.md`, // 插件规范文档
    PLUGIN_ERROR_CODE_DOC: `${DOCS_URL_PREFIX}/docs/markdown/ZH/Devops/UserGuide/Developer/plugins/plugin-dev-standard/plugin-error-code.md`, // 插件错误码文档
