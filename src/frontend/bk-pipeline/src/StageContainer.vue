<template>
    ...
    >
        <Logo v-if="reactiveData.editable || stageIndex !== 0" size="12" name="right-shape" class="container-connect-triangle" />
        <template v-if="containerIndex === 0">
            <cruve-line v-if="reactiveData.editable || stageIndex !== 0" class="first-connect-line connect-line left" :width="58" :height="60" />
        ...
        <template v-if="containerIndex !== containerLength - 1">
            <cruve-line v-if="reactiveData.editable || stageIndex !== 0" :straight="true" :width="58" :height="cruveHeight" class="connect-line left" />
