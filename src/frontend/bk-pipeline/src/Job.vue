<template>
    <div :class="{
        ...
        <atom-list v-if="showAtomList" ref="atomList" :stage="stage" :container="container" :stage-index="stageIndex"
            :handle-change="handleChange" :container-index="containerIndex" :container-group-index="containerGroupIndex"
            :container-status="containerStatus" :container-disabled="disabled">
        </atom-list>
    </div>
</template>
